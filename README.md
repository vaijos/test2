# network-ticketing-system with Cloud Code

![Architecture Diagram](./img/diagram.png)

"network-ticketing-system" is a simple Kubernetes application that contains a single
...
Sample configmap and secret files has been added to the kubernetes-manifests and dev-tmpl folder. Please modify those files with actual values before you deploy.
